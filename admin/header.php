...
// ดึงจำนวนผู้ใช้ที่ลงทะเบียนใหม่ (ภายในวันนี้)
$sql_new_users = "SELECT COUNT(*) AS new_user_count FROM users WHERE DATE(created_at) = CURDATE()";
...
// ดึงข้อมูลรายละเอียดผู้ใช้ที่ลงทะเบียนใหม่
$sql_user_details = "SELECT username, created_at FROM users WHERE DATE(created_at) = CURDATE() ORDER BY created_at DESC";
...
<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
    <li class="dropdown-header">
      You have <?php echo $new_user_count; ?> new notification(s)
